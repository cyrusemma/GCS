          ...
          >
            {steps.map(({ Icon, title, text }, i) => (
              <motion.div
                ...
                className="relative bg-crown-white rounded-xl p-6 text-center border border-gray-100"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-12">
              ...
              <table className="w-full text-sm text-left">
                ...
                <tbody>
                  {requirements.map((r, i) => (
                    <tr key={r.level} className={i % 2 ? "bg-crown-white" : "bg-white"}>
                      <td className="px-4 py-3 font-medium text-crown-blue align-top">{r.level}</td>
                      <td className="px-4 py-3 text-gray-700">{r.docs}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
          ...
          <div>
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              {fees.map((f) => (
                <div key={f.level} className="bg-white rounded-xl p-5 border border-gray-100 shadow-sm">
                  <h3 className="font-poppins font-semibold text-crown-blue">{f.level}</h3>
      ...
      <section className="py-16 lg:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-3 gap-6 items-stretch">
            <div className="bg-crown-white rounded-xl p-6 border border-gray-100">
              <h3 className="font-poppins font-semibold text-crown-blue mb-2">Boys</h3>
            ...
            <div className="bg-crown-white rounded-xl p-6 border border-gray-100">
              <h3 className="font-poppins font-semibold text-crown-blue mb-2">Girls</h3>
              <p className="text-sm text-gray-600">
            ...
            <div className="bg-crown-white rounded-xl p-6 border border-gray-100">
              <h3 className="font-poppins font-semibold text-crown-blue mb-2">PE Uniform</h3>
              <p className="text-sm text-gray-600">
          ...
          <div className="mt-6 flex items-center gap-4">
            <div
              className="h-20 w-20 rounded-lg bg-checkered border border-gray-200 shrink-0"
              aria-hidden="true"
            />
            <p className="text-sm text-gray-600">
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <fieldset className="space-y-4">
              <legend className="font-poppins font-semibold text-crown-blue text-lg border-b-2 border-crown-gold pb-2 w-full">
            ...
            <button
              type="submit"
              className="w-full bg-crown-gold hover:bg-crown-gold-light text-crown-blue-dark font-semibold py-3.5 rounded-full transition-colors"
            >
              Submit Application
            </button>
          </form>
            ...
            {faqs.map((f, i) => {
              ...
              return (
                <div key={i} className="border border-gray-200 rounded-xl overflow-hidden bg-white">
                  ...
                  >
                    <span className="font-medium text-crown-blue">{f.q}</span>
        ...
        {submitted && (
          ...
          >
            ...
            >
              ...
              <h3 className="font-poppins font-bold text-2xl text-crown-blue">Application Received!</h3>
